...
public class AppointmentAdapter extends RecyclerView.Adapter<AppointmentAdapter.AppointmentViewHolder> {
    ...
    public  class AppointmentViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Appointment appointment) {
            ...
            if (sharedViewModel.getIfUserAdmin()) {
            ...
            overflowMenu.setOnClickListener(v -> {
                ...
                popupMenu.setOnMenuItemClickListener(item -> {
                    ...
                    if (itemId == R.id.action_edit) {
                        sharedViewModel.setSelectedAppointment(appointment);
                        sharedViewModel.setDate(appointment.getDate());
                        sharedViewModel.setTime(appointment.getTime());
                        sharedViewModel.setUserToUpdate(appointment.getUser());
